...
or,
    ...
    (Put brassmonkeyjs folder some where on an http server and then open it's url ../brassmonkeyjs. Working on making it be able to be hosted without a server via file:// too.)
