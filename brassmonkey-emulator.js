...
function initializeDOM(){
  ...
  document.body.insertBefore(bm.dom,document.body.firstChild);
  ...
  bm.dom.style.position = "absolute";
  bm.dom.style.overflow = "hidden";
  bm.dom.style.border = "thin solid grey";
  ...
  for(var i = 0; i<bm.options.design.layout.length; i++){
    ...
    if(type=="image"){
      ...
      //img.src = "/developers/html5/images/debug-up.png";//bm.options.design.images[elem.imageUp];
    }
...
bm.onDeviceConnected = 
bm.onDeviceDisconnected = 
bm.onInvocation = 
bm.onShowSlot = 
noop;
