...
(function () {
    ...
    cr.runtime = function (canvas) {
      ...
      bm.onDeviceConnected(function(device){
        bm.enableTouch(deviceId,true,1.0/60.0);
        bm.setNavMode();
      });
...
cr.getProjectModel = function () {
    ...
    null, "Main Menu", [
        ...
        ["t12", cr.plugins_.Sprite, null, [
            ["Default", 5, false, 1, 0, false, [
                ["images/play_btn-default-000.png", 957, 1, 0.5, 1.707937, [],
                    [-0.458333*multiplier, -0.412698*multiplier, 0*multiplier, -0.507937*multiplier, 0.458333*multiplier, -0.412698*multiplier, 0.5*multiplier, -0.0158736*multiplier, 0.458333*multiplier, 0.396825*multiplier, 0*multiplier, 0.492063*multiplier, -0.458333*multiplier, 0.396825*multiplier, -0.5*multiplier, -0.0158736*multiplier]
                ]
            ]]
        ],
            [], false],
        ...
        ["Main Menu", 960, 640, false, "Main Menu Sheet", [
            ["Layer 0", 0, true, "rgb(255, 255, 255)", false, 1, 1, 1, false, 1, [
                ...
                [
                    [480, 752, 0, 144, 63, 0, 0, 1, 0.5, 0.507937], 12, [],
                    [],
                    [
                    0, 0, 0, 0]
                ],
