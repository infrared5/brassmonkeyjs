...
(function()
	...
	function G(a)
	{
		a/=bm.options.design.orientation=="portrait"?640:960;return a;
	}
	function L(a)
	{
		a/=bm.options.design.orientation=="portrait"?960:640;
		return a;
	}
	...
	function H(a,b)
	{
        ...
        if(a.layout[c].hitRect!==undefined){
          e+='<HitRect top="'+L(a.layout[c].hitRect.y)+'" left="'+G(a.layout[c].hitRect.x)+'" width="'+G(a.layout[c].hitRect.width)+'" height="'+L(a.layout[c].hitRect.height)+'"/>\n';
        }
...
bm.showSlotInternal=function(a){bm.onShowSlotInternal(C[(Math.max(1,a)-1)%C.length])};var o=[];
